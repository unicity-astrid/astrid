//! Astralis Approval - Human-in-the-loop approval system.
//!
...
//! the security system. The types in [`astralis_core::frontend`] are the
...
//!
//! ```
//! use astralis_approval::{SensitiveAction, ApprovalRequest, ApprovalDecision, RiskAssessment};
