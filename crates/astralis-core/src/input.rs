...
//! This is foundational to Astralis security - the system always knows WHO
...
//!
//! ```rust
//! use astralis_core::input::{TaggedMessage, MessageId, ContextIdentifier};
...
///
/// This is the core unit of input to the Astralis system. The LLM sees
...
pub struct TaggedMessage {
    ...
    /// Who sent this message (Astralis identity - spans frontends)
    pub astralis_user_id: AstralisUserId,
...
impl TaggedMessage {
    ...
    pub fn new(
        ...
        astralis_user_id: AstralisUserId,
    ...
    pub fn is_signed(&self) -> bool {
        self.user_signature.is_some() && self.astralis_user_id.has_signing_key()
    }
    ...
    pub fn signable_data(&self) -> Vec<u8> {
        ...
        data.extend(self.astralis_user_id.id.as_bytes());
