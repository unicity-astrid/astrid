//! Mirror Rust types for the WIT plugin ABI (`astralis:plugin@0.1.0`).
//!
//! These types are the shared vocabulary between the Astralis host and WASM
//! plugin guests. They mirror the records and enums defined in
//! `wit/astralis-plugin.wit` exactly, ensuring a single source of truth for
