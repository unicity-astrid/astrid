...
pub struct FileLogConfig {
    ...
    /// File name prefix (e.g., "astrid" produces "astrid.2024-01-15.log").
...
pub struct LogConfig {
    ...
    #[serde(default = "default_true")]
    pub ansi: bool,
    /// Directive overrides (e.g., `astrid_mcp=debug`).
    #[serde(default)]
...
mod tests {
    ...
    fn test_log_config_builder() {
        ...
        assert_eq!(config.directives, vec!["astrid_mcp=trace"]);
    }
    ...
    fn test_build_filter() {
        let config = LogConfig::new("debug").with_directive("astrid=trace");
