...
use astralis_core::{
    ApprovalDecision, ApprovalOption, ApprovalRequest, AstralisUserId, ElicitationRequest,
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            context: FrontendContext::new(
                ...
                FrontendUser::new("test-user").with_astralis_id(user_id),
                ChannelInfo {
