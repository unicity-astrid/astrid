...
//! [`PluginContext`](astralis_core::plugin_abi::PluginContext) and interpreting
//! the returned [`PluginResult`](astralis_core::plugin_abi::PluginResult).
//!
//! Host functions are shared with the plugin system via
//! [`astralis_plugins::wasm::host_functions`].
...
use astralis_core::plugin_abi;
use astralis_plugins::PluginId;
use astralis_plugins::wasm::host_functions::register_host_functions;
use astralis_plugins::wasm::host_state::HostState;
