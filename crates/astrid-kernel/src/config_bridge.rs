//! Bridge from unified `astrid_config::Config` to `GatewayConfig`.
//!
...
/// Convert a unified [`astrid_config::Config`] into a [`GatewayConfig`].
///
...
#[must_use]
pub fn from_unified_config(cfg: &astrid_config::Config) -> GatewayConfig {
