...
pub struct EventBus {
    ...
    sender: broadcast::Sender<Arc<AstralisEvent>>,
...
impl EventBus {
    ...
    pub fn publish(&self, event: AstralisEvent) -> usize {
...
pub struct EventReceiver {
    receiver: broadcast::Receiver<Arc<AstralisEvent>>,
}
...
impl EventReceiver {
    ...
    pub async fn recv(&mut self) -> Option<Arc<AstralisEvent>> {
        loop {
    ...
    pub fn try_recv(&mut self) -> Option<Arc<AstralisEvent>> {
        loop {
