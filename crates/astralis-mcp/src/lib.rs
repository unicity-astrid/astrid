//! Astralis MCP - MCP client with server lifecycle management.
//!
//! This crate provides:
...
//!
//! # async fn example() -> Result<(), astralis_mcp::McpError> {
...
pub use capabilities::{
    AstralisClientHandler, CapabilitiesHandler, ElicitationHandler, RootsHandler, RootsRequest,
    RootsResponse, SamplingHandler, SamplingRequest, SamplingResponse, UrlElicitationHandler,
};

// Re-export canonical elicitation types from astralis-core for convenience.
// These are the single source of truth — no duplicates in astralis-mcp.
pub use astralis_core::{
