...
fn mapping_for_event(event_type: &str) -> Option<HookMapping> {
    match event_type {
        // Session lifecycle
        "lifecycle.v1.session_created" => Some(HookMapping {
            hook_name: "session_start",
            merge: MergeSemantics::None,
        }),
        "lifecycle.v1.session_ended" => Some(HookMapping {
            hook_name: "session_end",
            merge: MergeSemantics::None,
        }),

        // Tool hooks
        "lifecycle.v1.tool_call_started" => Some(HookMapping {
            hook_name: "before_tool_call",
            merge: MergeSemantics::ToolCallBefore,
        }),
        "lifecycle.v1.tool_call_completed" => Some(HookMapping {
            hook_name: "after_tool_call",
            merge: MergeSemantics::LastNonNull {
                field: "modified_result",
            },
        }),
        "lifecycle.v1.tool_result_persisting" => Some(HookMapping {
        ...
        // Message hooks
        "lifecycle.v1.message_received" => Some(HookMapping {
            hook_name: "message_received",
            merge: MergeSemantics::None,
        }),
        "lifecycle.v1.message_sending" => Some(HookMapping {
            hook_name: "message_sending",
            merge: MergeSemantics::LastNonNull {
                field: "modified_content",
            },
        }),
        "lifecycle.v1.message_sent" => Some(HookMapping {
            hook_name: "message_sent",
            merge: MergeSemantics::None,
        }),

        // Sub-agent hooks
        "lifecycle.v1.sub_agent_spawned" => Some(HookMapping {
            hook_name: "subagent_start",
            merge: MergeSemantics::None,
        }),
        "lifecycle.v1.sub_agent_completed"
        | "lifecycle.v1.sub_agent_failed"
        | "lifecycle.v1.sub_agent_cancelled" => Some(HookMapping {
            hook_name: "subagent_stop",
            merge: MergeSemantics::None,
        }),

        // Context compaction (broadcast-only observation hooks)
        "lifecycle.v1.context_compaction_started" => Some(HookMapping {
            hook_name: "on_compaction_started",
            merge: MergeSemantics::None,
        }),
        "lifecycle.v1.context_compaction_completed" => Some(HookMapping {
            hook_name: "on_compaction_completed",
            merge: MergeSemantics::None,
        }),

        // Kernel lifecycle
        "lifecycle.v1.kernel_started" => Some(HookMapping {
            hook_name: "kernel_start",
            merge: MergeSemantics::None,
        }),
        "lifecycle.v1.kernel_shutdown" => Some(HookMapping {
...
impl HookBridge {
    ...
    pub fn on_session_created(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.session_created", payload)?;
        Ok(())
    }
    ...
    pub fn on_session_ended(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.session_ended", payload)?;
        Ok(())
    }
    ...
    pub fn on_tool_call_started(&self, payload: serde_json::Value) -> Result<Vec<u8>, SysError> {
        handle_lifecycle("lifecycle.v1.tool_call_started", payload)
    }
    ...
    pub fn on_tool_call_completed(&self, payload: serde_json::Value) -> Result<Vec<u8>, SysError> {
        handle_lifecycle("lifecycle.v1.tool_call_completed", payload)
    }
    ...
    pub fn on_tool_result_persisting(
        ...
        handle_lifecycle("lifecycle.v1.tool_result_persisting", payload)
    }
    ...
    pub fn on_message_received(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.message_received", payload)?;
        Ok(())
    }
    ...
    pub fn on_message_sending(&self, payload: serde_json::Value) -> Result<Vec<u8>, SysError> {
        handle_lifecycle("lifecycle.v1.message_sending", payload)
    }
    ...
    pub fn on_message_sent(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.message_sent", payload)?;
        Ok(())
    }
    ...
    pub fn on_subagent_spawned(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.sub_agent_spawned", payload)?;
        Ok(())
    }
    ...
    pub fn on_subagent_completed(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.sub_agent_completed", payload)?;
        Ok(())
    }
    ...
    pub fn on_subagent_failed(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.sub_agent_failed", payload)?;
        Ok(())
    }
    ...
    pub fn on_subagent_cancelled(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.sub_agent_cancelled", payload)?;
        Ok(())
    }
    ...
    pub fn on_compaction_started(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.context_compaction_started", payload)?;
        Ok(())
    }
    ...
    pub fn on_compaction_completed(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.context_compaction_completed", payload)?;
        Ok(())
    }
    ...
    pub fn on_kernel_started(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.kernel_started", payload)?;
        Ok(())
    }
    ...
    pub fn on_kernel_shutdown(&self, payload: serde_json::Value) -> Result<(), SysError> {
        let _ = handle_lifecycle("lifecycle.v1.kernel_shutdown", payload)?;
        Ok(())
    }
}
