...
//! `astralis-approval`'s `SecurityInterceptor` is available behind the
...
mod interceptor_gate {
    use super::*;
    use astralis_approval::action::SensitiveAction;
    use astralis_approval::interceptor::SecurityInterceptor;
    use astralis_core::types::Permission;
    use std::sync::Arc;
