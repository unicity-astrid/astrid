...
//!
//! The lockfile (`.astralis/plugins.lock` at workspace level,
//! `~/.astralis/plugins.lock` at user level) tracks exactly
...
pub enum PluginSource {
    ...
    /// Fetched from the Astralis plugin registry.
    Registry(String),
}
...
impl PluginLockfile {
    ...
    fn save_inner(&self, path: &Path) -> PluginResult<()> {
        let header = "# Auto-generated by astralis. Do not edit manually.\n\n";
...
mod tests {
    ...
    fn save_and_load_round_trip() {
        ...
        assert!(content.starts_with("# Auto-generated by astralis."));
