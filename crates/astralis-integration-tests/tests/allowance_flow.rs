...
async fn test_session_approval_flow() {
    ...
    assert!(
        matches!(
            ...
            astralis_approval::InterceptProof::SessionApproval { .. }
        ),
    ...
    assert!(
        matches!(
            ...
            astralis_approval::InterceptProof::Allowance { .. }
        ),
...
async fn test_preexisting_allowance_auto_approves() {
    ...
    let allowance = astralis_approval::Allowance {
        id: astralis_approval::AllowanceId::new(),
        action_pattern: astralis_approval::AllowancePattern::ExactTool {
...
async fn test_workspace_allowance_does_not_match_different_workspace() {
    ...
    let allowance = astralis_approval::Allowance {
        id: astralis_approval::AllowanceId::new(),
        action_pattern: astralis_approval::AllowancePattern::FilePattern {
            pattern: "/project-a/src/**".to_string(),
            permission: astralis_core::types::Permission::Read,
        },
        created_at: astralis_core::types::Timestamp::now(),
        expires_at: None,
        max_uses: None,
