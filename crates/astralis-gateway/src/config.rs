...
impl RetrySettings {
    ...
    #[must_use]
    pub fn llm_retry_config(&self) -> astralis_core::RetryConfig {
        astralis_core::RetryConfig::new(
    ...
    #[must_use]
    pub fn mcp_retry_config(&self) -> astralis_core::RetryConfig {
        astralis_core::RetryConfig::new(
...
mod tests {
    ...
    fn test_parse_config() {
        ...
        assert_eq!(config.gateway.state_dir, "/tmp/astralis");
