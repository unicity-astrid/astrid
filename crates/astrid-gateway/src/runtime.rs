...
use astrid_runtime::SubAgentPool;
...
impl GatewayRuntime {
    ...
    pub async fn start(&mut self) -> GatewayResult<()> {
        ...
        *self.runtime_state.write().await = RuntimeState::Running;
        ...
        self.event_bus.publish(AstridEvent::GatewayStarted {
    ...
    pub async fn reload_config(&self) -> GatewayResult<()> {
        ...
        *config = new_config;
        ...
        self.event_bus.publish(AstridEvent::ConfigReloaded {
            metadata: EventMetadata::new("gateway"),
        });
        ...
        loop {
            tokio::select! {
                ...
                _ = health_timer.tick() => {
                    ...
                    self.event_bus.publish(AstridEvent::HealthCheckCompleted {
                        metadata: EventMetadata::new("gateway"),
    ...
    pub async fn shutdown(&mut self) -> GatewayResult<()> {
        *self.runtime_state.write().await = RuntimeState::ShuttingDown;
        ...
        self.event_bus.publish(AstridEvent::GatewayShutdown {
            metadata: EventMetadata::new("gateway"),
