...
//! Unified configuration system for the Astralis runtime.
//!
...
//!
//! 1. **Workspace** (`{workspace}/.astralis/config.toml`) — can only *tighten* security
//! 2. **User** (`~/.astralis/config.toml`)
//! 3. **System** (`/etc/astralis/config.toml`)
//! 4. **Environment variables** (`ASTRALIS_*`, `ANTHROPIC_*`) — fallback only
//! 5. **Embedded defaults** (`defaults.toml` compiled into binary)
//!
//! # Design
//!
//! This crate has **no dependencies on other internal astralis crates**. It only
