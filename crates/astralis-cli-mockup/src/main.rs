...
//! Astralis CLI Mockup - UI/UX prototype for the interactive experience.
//!
...
//!
//! Run with: `cargo run -p astralis-cli-mockup`
//!
//! Or run a specific demo scenario:
//! `cargo run -p astralis-cli-mockup -- --demo simple-qa`
//!
//! Or capture snapshots without interactive mode:
//! `cargo run -p astralis-cli-mockup -- --snapshot showcase --steps 5`
