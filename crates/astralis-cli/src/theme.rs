...
impl Theme {
    ...
    pub(crate) fn approval_box(
        title: &str,
        content: &str,
        risk: astralis_core::RiskLevel,
    ) -> String {
        let color_fn = match risk {
            astralis_core::RiskLevel::Low => |s: &str| s.green().to_string(),
            astralis_core::RiskLevel::Medium => |s: &str| s.yellow().to_string(),
            astralis_core::RiskLevel::High => |s: &str| s.red().to_string(),
            astralis_core::RiskLevel::Critical => |s: &str| s.red().bold().to_string(),
        };
    ...
    /// Format a risk level.
    pub(crate) fn risk_level(level: astralis_core::RiskLevel) -> String {
        match level {
            astralis_core::RiskLevel::Low => "Low".green().to_string(),
            astralis_core::RiskLevel::Medium => "Medium".yellow().to_string(),
            astralis_core::RiskLevel::High => "High".red().to_string(),
            astralis_core::RiskLevel::Critical => "Critical".red().bold().to_string(),
        }
    }
